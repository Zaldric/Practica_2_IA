...
public class M16B06b extends Mouse {
    ...
    /**
     * Constructor de nuestro raton donde se inicializan los atributos como es
     * conveniente.
     *
     */
    public M16B06b() {
    ...
    /**
     *
     * Funcion que inserta en una cola las siguientes casillas que deben ser
     * visitadas y en que orden para realizar el movimiento en anchura de forma
     * idonea
     *
     * @param casilla Casilla en la que se encuentra el raton en un momento
     * concreto.
     */
    private void aniadirCola(Grid casilla) {
     ...
     * Funcion para realizar el algoritmo A*.
     *
     * @param inicio: pair de la casilla a la cual queremos calcular su
     * distancia usando manhattan.
    ...
    /**
     * Funcion para realizar la exploracion intentando ir hacia una casilla ya
     * conocida en caso de muerte.
     *
     * @param casilla: la casilla en la que se encuentra nuestro raton.
     * @param queso: objetivo al que se quiere llegar.
     * @return el moviemiento a realizar.
    ...
    /**
     * Funcion a la que se llama cuando aparece un nuevo queso, se procede a
     * reiniciar nuestras estructuras.
     */
    @Override
    ...
    /**
     * Funcion a la que se llama cuando nuestro raton muere, se procede a
     * reiniciar nuestras estructuras.
     */
    @Override
    ...
    /**
     * Funcion para calcular si se puede realizar un movimiento en una direccion
     * dada.
     *
    ...
    /**
     * Funcion heuristica para A* para calcular la direccion a la que
     * desplazarnos.
     *
    ...
    /**
     * Funcion de dispersion para calcular un pair adyacente a otro dada una
     * direccion.
     *
     * @param x: la componente x de una casilla.
     * @param y: la componente y de una casilla.
     * @param direccion: la casilla adyacente a la cual se quiere obtener su
     * pair correspondiente.
